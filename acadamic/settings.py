"""
Django settings for acadamic project.
...
SECRET_KEY = 'django-insecure-b29t+rb55)z5qtx$f&*tn!x7(!^p@=0zb6r+%hv=-cxm)si5b3'
...
WSGI_APPLICATION = 'acadamic.wsgi.application'
